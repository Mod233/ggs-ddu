...
using namespace std;
map<string,int> show;
char *dir= "/mnt/myusbmount/Trojan_Monitor/beijing/dns/4000300005.pcap.cap";
string result= "/mnt/myusbmount/Trojan_Monitor/dns_flow/";
