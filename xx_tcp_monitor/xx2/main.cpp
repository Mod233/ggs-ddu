...
char cap[] = "/root/4/4.pcap";

//char cap[] = "/root/16mm/cmdrat.pcap";//n 6/9=2/3=0.6666
//char cap[] = "/root/16mm/darkmoon.pcap";
//char cap[] = "/root/16mm/gh0st.pcap";
//char cap[] = "/root/16mm/spy-net.pcap";//unk port<1024
//char cap[] = "/root/16mm/xdoor.pcap";

//char cap[] = "/root/11mm/fbi.pcap";
//char cap[] = "/root/11mm/ghost.pcap";//c y
//char cap[] = "/root/11mm/hongheirat.pcap";//n up/sum=0.09
//char cap[] = "/root/11mm/ratflooder.pcap";//c y
//char cap[] = "/root/11mm/remoteghost.pcap";//c y
//char cap[] = "/root/11mm/ruser.pcap";//unk port<1024 reconnect
//char cap[] = "/root/11mm/shuang.pcap";
//char cap[] = "/root/11mm/star.pcap";
//char cap[] = "/root/11mm/ximenrat.pcap";//n up/sum=0.06
//char cap[] = "/root/11mm/yiyuyan.pcap";//c y
//char cap[] = "/root/11mm/yuanxiaojie.pcap";//c y
...
static int Make_TCP_Judgement(void)
{
	...
	if(outnet_ctl) //可能有外部控制特征
	{
		...
		else if (t_num > 0 && (float)(o_num)/(float)(t_num) > 0.6) //外部控制簇数占比过高，是木马
